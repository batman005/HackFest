        ...
        <>
            <div className="pt-24 bg-ARbg text-white">
                ...
                <div className="grid w-full py-10 place-items-center">
                    ...
                    <div className="font-roboto text-justify text-xl w-86 mt-2 mx-4 md:mx-44">Poloxamers are nonionic compounds that contains a large group of copolymers surfactants formed by chains of ethylene oxide block (EO) and propylene oxide (PO) (OEx–POy–OEx).</div>
                </div>

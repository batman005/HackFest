...
function Details() {
    ...
    if (snap.current === "Material.003") {
        ...
        return (
            <div className="h-full md:flex md:flex-col md:justify-center font-roboto">
                <h1 className="text-2xl tracking-wider">Click on diffrent parts of Atoms to know more</h1>
                <p className="self-center mx-8 text-xl tracking-wide text-justify font-roboto">To view the 3D model in AR, scan the QR code or click on the button below.</p>
                ...
                <div className="grid justify-center grid-cols-1 gap-2 pb-8 mx-8 md:grid-cols-2 lg:grid-cols-2">
                    ...
                    <a href="https://go.echo3d.co/2KMW" target="_blank" rel="noreferrer">
                        <button className="h-12 px-8 ml-8 text-base font-semibold tracking-wider text-white border rounded-full shadow-sm font-roboto mt-16 bg-red-50 bg-gradient-to-r from-purple-400 via-pink-500 to-red-500 hover:shadow-lg">View in AR</button>
                    </a>
                </div>
            </div>
        )
        ...
        <>
            <div className="pt-24 bg-ARbg text-white">
                ...
                <div className="grid w-full py-10 place-items-center">
                    <h1 className="pb-2 text-5xl font-semibold tracking-wide font-roboto lg:text-6xl">
                    Atom
                    </h1>
                    <div className="inline-flex h-1 bg-indigo-300 rounded-full w-72"></div>
                    <div className="font-roboto text-justify text-xl w-86 mt-2 mx-4 md:mx-44">An atom is the smallest unit of ordinary matter that forms a chemical element. Every solid, liquid, gas, and plasma is composed of neutral or ionized atoms. Atoms are extremely small, typically around 100 picometers across.</div>
                </div>
